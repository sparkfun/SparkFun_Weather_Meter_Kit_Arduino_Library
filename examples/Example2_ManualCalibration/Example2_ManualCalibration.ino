...
void setup()
{
    ...
    weatherMeterKit.windDirMaxADC = 255;
    ...
    weatherMeterKit.windDirPullUpVal = 10000;
    ...
    weatherMeterKit.vaneResistances[WMK_ANGLE_0_0] = 33000;
    weatherMeterKit.vaneResistances[WMK_ANGLE_22_5] = 6570;
    weatherMeterKit.vaneResistances[WMK_ANGLE_45_0] = 8200;
    weatherMeterKit.vaneResistances[WMK_ANGLE_67_5] = 891;
    weatherMeterKit.vaneResistances[WMK_ANGLE_90_0] = 1000;
    weatherMeterKit.vaneResistances[WMK_ANGLE_112_5] = 688;
    weatherMeterKit.vaneResistances[WMK_ANGLE_135_0] = 2200;
    weatherMeterKit.vaneResistances[WMK_ANGLE_157_5] = 1410;
    weatherMeterKit.vaneResistances[WMK_ANGLE_180_0] = 3900;
    weatherMeterKit.vaneResistances[WMK_ANGLE_202_5] = 3140;
    weatherMeterKit.vaneResistances[WMK_ANGLE_225_0] = 16000;
    weatherMeterKit.vaneResistances[WMK_ANGLE_247_5] = 14120;
    weatherMeterKit.vaneResistances[WMK_ANGLE_270_0] = 120000;
    weatherMeterKit.vaneResistances[WMK_ANGLE_292_5] = 42120;
    weatherMeterKit.vaneResistances[WMK_ANGLE_315_0] = 64900;
    weatherMeterKit.vaneResistances[WMK_ANGLE_337_5] = 21880;
    ...
    weatherMeterKit.mmPerRainfallCount = 0.2794;
    ...
    weatherMeterKit.minMillisPerRainfall = 100;
    ...
    weatherMeterKit.kphPerCountPerSec = 2.4;
